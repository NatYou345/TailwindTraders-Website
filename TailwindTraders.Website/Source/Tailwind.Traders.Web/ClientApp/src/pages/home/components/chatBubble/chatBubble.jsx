...
import chatIcon from "../../../../assets/images/chat-bubble-icon.svg?react";
import { useNavigate } from "react-router-dom";
import axios from "axios";
import callIcon from "../../../../assets/images/icon-call.svg?react";
...
export default function ChatBubbleWithNavigation(props) {
  const navigate = useNavigate();
  return <ChatBubble {...props} history={{ push: navigate }} />;
}
