...
import Hamburger from '../../assets/images/icon-menu.svg?react';
...
const HeaderWithNavigation = (props) => {
    ...
    return <Header {...props} history={{ push: navigate }} />;
};

export default connect(mapStateToProps, { clickAction })(withTranslation()(HeaderWithNavigation));
