...
import PhotoImg from "../../assets/images/icon-photo.svg?react";
...
const UploadFileWithNavigation = (props) => {
    const navigate = useNavigate();
    return <UploadFile {...props} history={{ push: navigate }} />;
};

export default connect(mapStateToProps)(UploadFileWithNavigation);